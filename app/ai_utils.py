...
class AI:
    ...
    def create_new_title(self):
        response = self.model.generate_content(
            ...
            'okulum', 'tıpı ile ünlü okul',
            'hacettepe kariyer fuarını yapan okul'],
            topic: career, title: 'odtü' entries: [
            'mentorumun okulu',
            'açılımı ortadoğu teknik üniversitesi olan üniversite'],
            topic: career, title: 'technarts', entries: [
            'mentorumun okulu',
            'açılımı ortadoğu teknik üniversitesi olan üniversite'],
            topic: sport, title: 'paris yaz olimpiyatları', entries: [
            'güzel bi açılışla başlayan olimpiyat',
            'voleybolda yarı finalde elendiğimiz yarışmalar bütünü'],
            topic: sport, title: 'galatasaray', entries: [
            '<p>tuttuğum takım</p>',
            '<p>son <strong>süper lig</strong> şampiyonu<p>'],
    ...
    def get_new_entries_to_title(self, title, count):
        response = self.model.generate_content(
            """We have a dictionary which has titles and entries,
                ...
                topic: carrer, title: 'hacettepe', the entries: [
                'okulum',
                'tıpı ile ünlü okul', 'hacettepe kariyer fuarını yapan okul'],
                topic: career, title: 'odtü' entries: [
                'mentorumun okulu',
                'açılımı ortadoğu teknik üniversitesi olan üniversite'],
                topic: career, title: 'technarts', entries: [
